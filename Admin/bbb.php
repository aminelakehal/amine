...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="monMenu">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="./inscription.php" class="nav-item nav-link" id="inscription">Inscription</a>
                        <a href="./connexion.php" class="nav-item nav-link" id="connexion">Connexion</a>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <section class="container">
        <div class="row">
            ...
            $sql = "SELECT title, img_src, description FROM destination";
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-info"
                                    onclick="showDestination('<?php echo $row['title']; ?>')">Lire</button>
                            </div>
